...
async function processGeminiFunctionCall({ functionCall, client }) {
  ...
  // Based on the @google/genai documentation, the format should be:
  // { name: functionName, response: { content: JSON.stringify(result) } }
...
module.exports = {
  ...
  processGeminiFunctionCall, // Export the new function
};
